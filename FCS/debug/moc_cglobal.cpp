...
**
** Created: Sun Jul 21 11:26:54 2019
...
void CGlobal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData CGlobal::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CGlobal::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CGlobal,
      qt_meta_data_CGlobal, &staticMetaObjectExtraData }
};
